...
public class CommonTask extends Main {
    ...
    public static void pageNavigation(String to, Stage stage, Class<?> classes, String title, int width, int height)
            throws IOException {
        double xTemp = x;
        double yTemp = y;
    ...
    public static void showJFXAlert(StackPane rootPane, AnchorPane rootAnchorPane, String type, String heading,
            String message, JFXDialog.DialogTransition transition) {
        ...
        // layout.setStyle("-fx-background-color: #25263A; -fx-text-fill: white;
        // -fx-border-color: white; -fx-fill: white; -fx-progress-color: white");
        // layout.lookup(".dialog-pane:header .header-panel
        // .label").setStyle("-fx-text-fill: white; -fx-background-color: #25263a");
