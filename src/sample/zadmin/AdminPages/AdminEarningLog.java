...
public class AdminEarningLog implements Initializable {
        ...
        try {
            if (!connection.isClosed()) {
                ...
                while (resultSet.next()) {
                    ...
                    AdminEarningTable roomTablee = new AdminEarningTable(NID, ROOMNO, TYPE, CHECKEDIN, CHECKEDOUT,
                            PRICEDAY, TOTALPRICE);
    ...
    private void slipDownloadBtn() {
        Callback<TableColumn<AdminEarningTable, String>, TableCell<AdminEarningTable, String>> cellCallback = new Callback<TableColumn<AdminEarningTable, String>, TableCell<AdminEarningTable, String>>() {
            @Override
